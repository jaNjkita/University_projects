...
# Общая часть парсинга за 2020 год
url = 'https://monitoring.miccedu.ru/iam/2020/_vpo/inst.php?id=100256'
...
table1_2020 = pm.create_table(table_name, body_table)



# Парсинг остальных таблиц:
lst_tables_2020 = pm.parsing_more_tables(soup, 6)
...
lst_tables_region_2020 = pm.create_part_of_table(soup, 'analis_reg')



# Парсинг дополнительной таблицы
lst_tables_dop_2020 = pm.create_part_of_table(soup, 'analis_dop')



all_tables_2020 = [table1_2020, lst_tables_2020, lst_tables_region_2020, lst_tables_dop_2020]