...
# Общая часть парсинга за 2017 год
url = 'https://monitoring.miccedu.ru/iam/2017/_vpo/inst.php?id=100256'
...
table1_2017 = pm.create_table(table_name, body_table)



# Парсинг остальных таблиц:
lst_tables_2017 = pm.parsing_more_tables(soup, 7)




# Парсинг таблиц Роль организации в системе подготовки кадров для региона
lst_tables_region_2017 = pm.create_part_of_table_3(soup, 'analis_reg')



# Парсинг дополнительной таблицы
lst_tables_dop_2017 = pm.create_part_of_table(soup, 'analis_dop')




all_tables_2017 = [table1_2017, lst_tables_2017, lst_tables_region_2017, lst_tables_dop_2017]